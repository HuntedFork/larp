...
*Runs 11:30 AM – 5:00 PM. Times are **start times** only. Events are spread so that no two things happen in the same half hour. Add new **mods** to the open slots as they're written. (IndyMods are run ad-hoc and do NOT go on this timeline.)*
...
- **4:30 — Necromancer Attack:** A necromancer arrives leading a chained ghost (see the *Necromancer Attack* mod). After its first run it becomes a grab-bag mod.
- **5:00 — Game End:** Wrap up and resolve remaining threads.
